...
export default function App(props) {
  ...
  function editTask(id, newName, newDueDate, newDesc, completionDate) { // Add completionDate as a parameter
    const editedTaskList = tasks.map((task) => {
      // if this task has the same ID as the edited task
      if (id === task.id) {
        // Copy the task and update its name, due date, description, and completion date
        return { ...task, name: newName, dueDate: newDueDate, desc: newDesc, completionDate: completionDate };
      }
  ...
  function addTask(name, dueDate, desc) {
